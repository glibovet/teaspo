  ...
  <!--ICONS-->
    ...
    <body>
        ...
        <div class="information col-md-6">
            ...
            <label>Sport type:</label><text>${event.type}</text><br>
            <label>Capacity:</label><text>${event.capacity}</text><br>
            <label>Description:</label><br><text id="description"> ${event.description}</text><br>
